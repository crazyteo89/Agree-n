...
class AnimalTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cellIdentifier = "animalContent"
        ...
        cell.animalTitleLabel.text = animalNames[indexPath.row]
        cell.animalSubTitleLabel.text = animalDescription[indexPath.row]
        cell.animalThumbnailImage.image = UIImage(named: animalImages[indexPath.row])
