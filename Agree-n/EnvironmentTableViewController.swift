...
//  Agree-n
//
//  Created by Luca Kesler on 02/02/2017.
...
class EnvironmentTableViewController: UITableViewController {
    ...
    var envNames = ["Global Warming", "Water Scarcity"]
    var envDescription = ["Livestock ", "Intensive Breeding"]
    var rowImages = ["livestock.jpg", "waterScarcity.jpg"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.titleLabel.text = envNames[indexPath.row]
        cell.subTitleLabel.text = envDescription[indexPath.row]
        cell.thumbnailImage.image = UIImage(named: rowImages[indexPath.row])
